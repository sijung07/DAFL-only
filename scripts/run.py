...
from benchmark import generate_fuzzing_worklist, FUZZ_TARGETS, EVAL_FUZZ_TARGETS, \
    BINUTILS_FUZZ_TARGETS, BINUTILS_LONG_FUZZ_TARGETS
...
def main():
    ...
    elif "binutils-long" in target:
        benchmark = "binutils-long"
        target_list = [x for (x,y,z,w) in BINUTILS_LONG_FUZZ_TARGETS]
