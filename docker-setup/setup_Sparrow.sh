...
sed -i 's|opam pin add claml https://github.com/prosyslab/claml.git -n|opam pin add claml https://github.com/prosyslab/claml.git#ea23b9c19de06cb7a6c3ab3ca64bab539db18d25 -n|' build.sh
./build.sh
